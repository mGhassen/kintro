...
public class Job implements Serializable {
    ...
    public Job startDate(ZonedDateTime startDate) {
    ...
    public Job endDate(ZonedDateTime endDate) {
    ...
    public Job documentEmployees(Set<DocumentEmployee> documentEmployees) {
        this.documentEmployees = documentEmployees;
        return this;
    }

    public Job addDocumentEmployee(DocumentEmployee documentEmployee) {
        this.documentEmployees.add(documentEmployee);
        documentEmployee.setJob(this);
        return this;
    }

    public Job removeDocumentEmployee(DocumentEmployee documentEmployee) {
        this.documentEmployees.remove(documentEmployee);
        documentEmployee.setJob(null);
        return this;
    }
