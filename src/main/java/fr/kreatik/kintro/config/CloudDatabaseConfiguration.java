package fr.kreatik.kintro.config;
...
@Configuration
@EnableMongoRepositories("fr.kreatik.kintro.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("fr.kreatik.kintro.config.dbmigrations");
