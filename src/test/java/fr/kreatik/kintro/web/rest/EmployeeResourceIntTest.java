...
import fr.kreatik.kintro.domain.Employee;
import fr.kreatik.kintro.repository.EmployeeRepository;
...
public class EmployeeResourceIntTest {
    ...
    private static final Long DEFAULT_NATIONALITE = 1L;
    private static final Long UPDATED_NATIONALITE = 2L;
    ...
    public void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getNationalite()).isEqualTo(DEFAULT_NATIONALITE);
    }
    ...
    public void getAllEmployees() throws Exception {
        ...
        restEmployeeMockMvc.perform(get("/api/employees?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].nationalite").value(hasItem(DEFAULT_NATIONALITE.intValue())));
    }
    ...
    public void getEmployee() throws Exception {
        ...
        restEmployeeMockMvc.perform(get("/api/employees/{id}", employee.getId()))
            ...
            .andExpect(jsonPath("$.nationalite").value(DEFAULT_NATIONALITE.intValue()));
    }
    ...
    public void updateEmployee() throws Exception {
        ...
        assertThat(testEmployee.getNationalite()).isEqualTo(UPDATED_NATIONALITE);
    }
